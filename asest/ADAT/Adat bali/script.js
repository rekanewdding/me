...
function showMusicPlayButton() {
    ...
    musicPlayBtn.innerHTML = '<i class="fas fa-play"></i> Putar Musik';
...
// ===== COUNTDOWN TIMER =====
const weddingDate = new Date('2026-02-14T18:00:00+08:00').getTime(); // WITA (GMT+8)
    ...
    messages.forEach(msg => {
        ...
        messagesHTML += `
            <div class="message-item fade-in">
                ...
                <div class="message-time">${time} ${msg.attendance ? '• Akan hadir' : ''}</div>
...
if (sendGiftBtn) {
    sendGiftBtn.addEventListener('click', function() {
        showToast('Terima kasih! Konfirmasi hadiah Anda telah dicatat.');
    });
}
...
if (shareBtn) {
    shareBtn.addEventListener('click', function() {
        const shareData = {
            title: 'Undangan Pernikahan Adat Bali Gede & Ayu',
            text: 'Saya ingin mengundang Anda ke upacara pernikahan Gede & Ayu. Buka undangan digitalnya!',
        ...
        if (navigator.share) {
            ...
            navigator.clipboard.writeText(window.location.href)
                .then(() => showToast('Link undangan disalin ke clipboard!'))
...
function createParticles() {
    ...
    // Create flower petals (kembang rampai)
    for (let i = 0; i < 12; i++) {
...
// ===== CONSOLE GREETING =====
console.log('%c🎉 Undangan Pernikahan Adat Bali | Gede & Ayu 🎉', 'font-size: 18px; color: #800000; font-weight: bold;');
console.log('%cDibuat dengan ❤️ oleh Rekan Wedding', 'font-size: 14px; color: #B8860B;');